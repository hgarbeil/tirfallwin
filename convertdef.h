/*! \file convertlib.h
	...
	\defgroup conversion Coordinate conversion library
*/
...
//! \ingroup conversion
//! \defgroup conversion_constants Coordinate conversion constants
//! @{
...
//! \ingroup conversion
//! \defgroup conversion_typedefs Coordinate conversion typedefs
//! @{
...
//! Digital Elevation Map structure
/*! Stores an equirectangular array of elevation points.
*/
/*
typedef struct
	{
	...
	//! Last longitude
	double lon1;
	//! Pixel size East:West
	double dx;
	//! Pixel size North:South
	double dy;
	//! Array
	dem_pixel **pix;
	} demstruc;
