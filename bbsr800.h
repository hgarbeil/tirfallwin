...
public:
    ...
    void StartMonitor()
    {
        pthread_create(&thread_Monitor, NULL, &BbSr800::wrapperMonitor, &parm);
    }
    void StartControl()
    {
        pthread_create(&thread_Control, NULL, &BbSr800::wrapperControl, &parm);
    }
#else
...
private:
    ...
    {
        ((BbSr800*) thisPtr)->Monitor();
        return(NULL);
    }
    static void* wrapperControl(void* thisPtr)
    {
        ((BbSr800*) thisPtr)->Control();
        return(NULL);
    }
#else
