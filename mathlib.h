...
* - Coordinate system attitude conversion and RotationA
...
* Coordinate System Attitude Conversion and RotationA
*
* In support of RotationAs, types have been defined to support quaternions,
...
* been adopted:
* - Quaternions represent Left RotationA.
* - Euler angles represent a Right Handed, Intrinsic, ZYX, Tait-Bryan RotationA.
 ...
 * amount of RotationA. Can alternatively be thought of as a ::cvector,
...
cvector transform_q(quaternion q,cvector v);
