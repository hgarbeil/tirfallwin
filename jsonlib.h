...
*
* JSON is defined by the following key elements:
* - implements all elements of JSON except for arrays
...
int32_t json_out_1d(jstring *jstring,char *token, uint16_t col,cosmosstruc *cdata);
...
int32_t json_get_int_name_1d(const char *token, int index1, cosmosstruc *cdata);
uint32_t json_get_uint_name_1d(const char *token, int index1, cosmosstruc *cdata);
double json_get_double_name_1d(const char *token, int index1, cosmosstruc *cdata);
int32_t json_get_int_name_2d(const char *token, int index1, int index2, cosmosstruc *cdata);
uint32_t json_get_uint_name_2d(const char *token, int index1, int index2, cosmosstruc *cdata);
double json_get_double_name_2d(const char *token, int index1, int index2, cosmosstruc *cdata);
...
int32_t json_setup_node(char *node, cosmosstruc *cdata);

char *json_of_wildcard(jstring *jstring, char *wildcard, cosmosstruc *cdata);
char *json_of_list(jstring *jstring,char *tokens,cosmosstruc *cdata);
...
int32_t json_equation_map(char *name, cosmosstruc *cdata, jsonhandle *handle);
