...
//! Create RotationA matrix from 2 row vectors
/*! Generate the direction cosine matrix that represents a RotationA from one row order vector
...
//! Create RotationA quaternion from 2 row vectors
/*! Generate the quaternion that represents a RotationA from one row order vector
 * to a second row order vector.
	\param from initial row order vector
	\param to final row order vector
...
//! Create RotationA quaternion from row vector axis and angle
/*! Generate the quaternion that represents a RotationA of the specified angle
 * around the specified row vector axis.
	\param around row order vector around which the RotationA will occur
	\param angle amount of RotationA in radians
	\return quaternion that can be used to rotate points
*/
...
* represents the angle of RotationA in radians.
...
//! RotationA matrix for X axis
/*! Create the DCM that represents a RotationA of the given angle around the X axis.
	\param angle Angle of RotationA in radians
...
//! RotationA matrix for Y axis
/*! Create the DCM that represents a RotationA of the given angle around the Y axis.
	\param angle Angle of RotationA in radians
	\return Resulting DCM
*/
...
//! RotationA matrix for Z axis
/*! Create the DCM that represents a RotationA of the given angle around the Z axis.
	\param angle Angle of RotationA in radians
	\return Resulting DCM
*/
...
//! RotationA matrix for indicated axis
/*! Create the DCM that represents a RotationA of the given angle around the indicated axis.
	\param axis Axis of RotationA: 1=X, 2=Y, 3=Z
	\param angle Angle of RotationA in radians
	\return Resulting DCM
*/
 ...
 * provided left quaternion.
	...
	\param q quaternion representing the RotationA
...
//! Create RotationA matrix from 2 vectors
/*! Generate the direction cosine matrix that represents a RotationA from one cartesian vector
...
//! Create RotationA quaternion from 2 vectors
/*! Generate the quaternion that represents a RotationA of from one cartesian vector
 * to a second cartesian vector.
	\param from initial cartesian vector
	\param to final cartesian vector
	\return quaternion that can be used to rotate points
...
//! Create RotationA quaternion from axis and angle
/*! Generate the quaternion that represents a RotationA of the specified angle
 * around the specified axis.
	\param around cartesian vector around which the RotationA will occur
	\param angle amount of RotationA in radians
	\return quaternion that can be used to rotate points
*/
...
//! RotationA quaternion for X axis
/*! Create the ::quaternion that represents a RotationA of the given angle around the X axis.
	\param angle Angle of RotationA in radians
...
//! RotationA quaternion for Y axis
/*! Create the ::quaternion that represents a RotationA of the given angle around the Y axis.
	\param angle Angle of RotationA in radians
	\return Resulting ::quaternion
*/
...
//! RotationA quaternion for Z axis
/*! Create the ::quaternion that represents a RotationA of the given angle around the Z axis.
	\param angle Angle of RotationA in radians
	\return Resulting ::quaternion
*/
...
//! RotationA quaternion for indicated axis
/*! Create the ::quaternion that represents a RotationA of the given angle around the indicated axis.
	\param axis Axis of RotationA: 1=X, 2=Y, 3=Z
	\param angle Angle of RotationA in radians
	\return Resulting ::quaternion
*/
...
//! Identity quaternion
/*! Returns a quaternion that will cause no RotationA when multiplied by a vector.
