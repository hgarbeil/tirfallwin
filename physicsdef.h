...
//! \ingroup physicslib
//! \defgroup physicslib_constants COSMOS Orbit constants
//! @{
...
//! \ingroup physicslib
//! \defgroup physicslib_typedefs COSMOS Orbit typedefs
//! @{
...
typedef struct
{
	//! Offset to be applied to utc to get simulated utc.
	double utcoffset;
